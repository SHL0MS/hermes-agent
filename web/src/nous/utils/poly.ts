/**
 * Polymorphic component utility from @nous/design-language
 * Source: NousResearch/design-language/src/utils/poly.ts
 */
...
> = { as?: T } & Own &
  Omit<React.ComponentPropsWithoutRef<T>, 'as' | keyof Own>
